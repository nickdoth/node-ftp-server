...
var StaticFilesystem = (function () {
    ...
    StaticFilesystem.prototype.list = function (dir, cb) {
        ...
        fs.stat(target, function (err1, stat) {
            if (err1) {
                ...
                cb(null, (_a = {}, _a[path.basename(target)] = stat, _a));
                return;
            }
            else {
    ...
    StaticFilesystem.prototype.readFile = function (file, cb, seek) {
    ...
    StaticFilesystem.prototype.writeFile = function (file, cb, seek) {
        if (seek) {
